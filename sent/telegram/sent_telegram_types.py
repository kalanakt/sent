...
from sent_telegram_util import (
    chunks,
    ...
    def __html_text(self, text, entities):
        ...
        for entity in entities:
            if entity.offset > offset:
                ...
                html_text = (
                    html_text[:last_occurence]
                    + formatted_string
                    + html_text[last_occurence + string_length:]
                )
...
class InlineKeyboardMarkup(Dictionaryable, JsonSerializable, JsonDeserializable):
    ...
    .. note::
        It is recommended to use :meth:`telebot..quick_markup` instead.

    .. code-block:: python3
        :caption: Example of a custom keyboard with buttons.

        from telebot..import quick_markup
...
class ForumTopicCreated(JsonDeserializable):
    ...
    def __init__(
        self, name: str, icon_color: int, icon_custom_emoji_id: Optional[str] = None
    ) -> None:
        self.name: str = name
...
class ForumTopicEdited(JsonDeserializable):
    ...
    def __init__(
        self, name: Optional[str] = None, icon_custom_emoji_id: Optional[str] = None
    ) -> None:
